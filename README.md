...
## ✅ Executive Summary
* The four days spanning Black Friday and Cyber Monday (BFCM) was the standout period with AOV hitting $82.77 against a $69.99 pre-BFCM baseline. In this period there was also a 6.6% discount-driven uplift suggesting customers are upgrading their baskets rather than simply buying the cheapest available item, an important distinction for how future promotions should be structured.The Post-Christmas period experiences a slump with revenue falling over 50% to $2,113 per day and AOV dropping to $64.02, making broad discounting and continued CPC spend during this window a margin cost without the volume to justify it. The user behaviour story is consistent across periods.
